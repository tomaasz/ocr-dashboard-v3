#!/bin/bash
#
# OCR Dashboard V2 - Ubuntu Host Setup Script
# ===========================================
# This script configures a new Ubuntu host for running OCR workers
#
# Usage:
...
print_summary() {
    echo
    echo "=================================================="
    log_success "OCR Dashboard V2 - Ubuntu Setup Complete!"
    echo "=================================================="
    echo
...
main() {
    echo "=================================================="
    echo "  OCR Dashboard V2 - Ubuntu Host Setup"
    echo "=================================================="
    echo
